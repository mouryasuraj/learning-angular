let ourTupple: [number, string, string[], boolean] = [1,"Suraj",["str"], true]
...
let readonlyTupple: readonly [number, string, string[], boolean] = [1,"Mourya",["new Str"], false]
...
// Names tuples
const namesTuples: [x:number, y:string] = [45, "suraj"]
