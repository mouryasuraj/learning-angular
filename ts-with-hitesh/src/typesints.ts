...
// Annotation
let names:string = '' // string annotation
let arr:Array<number> = [1,2,3,4] // array annotation
let arr1:number[] = [1,2,3,4] // array annotation
let num:number = 0 // number annotation
let bool:boolean = true;   // boolean annotation
let id:(string|number|boolean| []) = []   // union annotation